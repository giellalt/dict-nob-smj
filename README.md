# Dictionary for nob — smj

This repository contains source files for a dictionary from Norwegian Bokmål to Lule Sámi. The content is licensed under the CC-BY-4.0 license.
